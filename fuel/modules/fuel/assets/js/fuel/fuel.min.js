...
newId)}})})};var createRemoveButton=function(elem){$elem=$(elem);if(!$elem.find("."+options.removeButtonClass).length){var $remove=$elem.find(options.removeSelector+":first");if($remove.length&&$remove.find(options.removeButtonClass).length==0)$remove.empty().append('<a href="#" class="'+options.removeButtonClass+'">'+options.removeButtonText+" </a>");else{$remove.remove(options.removeSelector);$elem.append('<a href="#" class="'+options.removeButtonClass+'">'+options.removeButtonText+" </a>")}}$(document).on("click",

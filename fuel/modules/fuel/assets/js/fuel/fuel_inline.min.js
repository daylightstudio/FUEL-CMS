...
function initFuelNamespace(){var f;if(window.fuel==undefined)if(top.window.fuel!=undefined)f=top.window.fuel;else f={};else f=window.fuel;return f}if(fuel==undefined)var fuel={};fuel.lang=function(key){return __FUEL_LOCALIZED__[key]};fuel.getFieldId=function(field,context){if(window.__FUEL_INLINE_EDITING!=undefined){var val=$(".__fuel_module__",context).attr("id");var prefix=val.split("--")[0];return prefix+"--"+field}else return field};

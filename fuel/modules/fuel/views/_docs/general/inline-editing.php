...
<img src="<?=img_path('screens/page_inline_editing.jpg', 'user_guide')?>" class="screen" />
...
<img src="<?=img_path('screens/inline_editing.jpg', 'user_guide')?>" class="screen" />

<p>Clicking the pencil will reveal the form to edit the module information.</p>
<img src="<?=img_path('screens/inline_editing_form.jpg', 'user_guide')?>" class="screen" />
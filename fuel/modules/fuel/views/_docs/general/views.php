...
if you are using the <a href="<?=user_guide_url('general/opt-in-controllers')?>">opt-in controller method</a> for displaying your page. Also, adding an underscore to your
...
<ul>
	...
	<li><strong>_variables</strong>: contains <a href="<?=user_guide_url('general/opt-in-controllers')?>">variables files</a></li>

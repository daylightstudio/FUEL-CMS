...
<div class="screenshot">
	<div class="overlay" style="top: 15px; left: 700px;">Last Backup</div>
	<div class="overlay" style="top: 65px; left: 120px;">Standard FUEL Module</div>
	<div class="overlay" style="top: 195px; left: 120px;">Blog Module</div>
	<div class="overlay" style="top: 305px; left: 120px;">Site Specific Modules</div>
...
<div class="screenshot">
	<div class="overlay" style="top: 5px; left: 240px;">View Options</div>
	<div class="overlay" style="top: 5px; left: 350px;">Create a New Item</div>
	<div class="overlay" style="top: 65px; left: 200px;">Sortable Columns</div>
	<div class="overlay" style="top: 115px; left: 700px;">Easy Publishing By <br />Clicking Publish Status</div>
...
<div class="screenshot">
	<div class="overlay" style="top: 5px; left: 440px;">Actions Bar</div>
	<div class="overlay" style="top: 5px; left: 700px;">Select Other Module Items</div>

...
an asset because it exists on the file system and not in a database. You can only create or delete. 
However, upon creation, you have the ability to overwrite a file with the same name which, in essence, 
is editing the asset. Also, because assets are saved on the file system and not in a database, you can use 

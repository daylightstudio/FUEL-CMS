...
<p>Think of Adanced Modules as another application folder that can contain it's own
controllers, helpers, libraries, langauge and view files. They can also contain their
...
<ol>
	...
	<li>Create your controller files. 
		<ul>
			...
			<li><strong>Dashboard Controller</strong> - If you add a controler with the name of <dfn>Dashboard</dfn>, then it can get pulled in to the FUEL admin (if the module is in the fuel $config['dashboards'] configuration)</li>
		</ul>
	</li>

...
<div id="main_content" class="noaction">
	...
	for automatically backing up your database. In fact, we already have an example for you at <?=INSTALL_ROOT.'crons'.DIRECTORY_SEPARATOR.'crontab_default.php'?>. Below is an easy to use interface to manage the schedule of the tasks. 

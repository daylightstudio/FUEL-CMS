...
UPDATE `fuel_users` SET password = 'f4c99eae874755b97610d650be565f1ac42019d1' WHERE id = 1;
UPDATE `fuel_users` SET salt = '429c6e14342dd7a63c510007a1858c26' WHERE id = 1;
UPDATE `fuel_users` SET first_name = 'admin' WHERE id = 1;
UPDATE `fuel_users` SET last_name = 'admin' WHERE id = 1;
